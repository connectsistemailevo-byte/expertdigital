  ...
  useEffect(() => {
    ...
    onlineProviders.forEach(provider => {
      ...
      if (existingMarker) {
        ...
        // Wrapper that contains both label and icon with fixed height
        el.innerHTML = `
          <div style="
            display: flex;
            flex-direction: column;
          ...
          ">
            ...
            <!-- Anchor point indicator (invisible) -->
        ...
        // Use anchor 'bottom' so the bottom of the icon stays fixed at the coordinate
